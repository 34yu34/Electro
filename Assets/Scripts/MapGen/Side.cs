...
public class Side
{
    ...
    public bool HasExactSides(Side other)
    {
        return (other & all) == (this & all);
    }

    public bool HasSidesOpen(Side sideToLook)
    {
        return (this & sideToLook) == sideToLook;
    }

    public bool HasSidesClosed(Side sideToLook)
    {
        return (this & sideToLook) == none;
    }
